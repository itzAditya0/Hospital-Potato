        ...
        <div className={styles.loginPage}>
            ...
            <div className={styles.loginContainer}>
                ...
                <div className={styles.loginBox}>
                    ...
                    <h2>For Patients</h2>
                    <p>
                        Take your healthcare to the next level. Take it into
                        your hands. You choose the care you need from a select
                        group of physicians from the convenience of your home.
                    </p>
                ...
                <div className={styles.loginBox}>
                    ...
                    <h2>For Doctors</h2>
                    <p>
                        Elevate your healthcare delivery—provide care to
                        patients efficiently. Improve your patient base and
                        access.
                    </p>
